  ...
  return (
    <section className="tt-reveal section-y">
      <Container className="grid gap-10 sm:gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
        ...
        <div className="tt-luxury-card divide-y divide-ink/10 rounded-[8px] dark:divide-chalk/15">
          {items.map((item) => (
            <div className="tt-micro-block p-5 sm:p-6" key={item.title}>
              <h3 className="font-serif text-xl font-medium leading-tight text-ink sm:text-2xl dark:text-chalk">{item.title}</h3>
