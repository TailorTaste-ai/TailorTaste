      ...
      <Container className="space-y-10 sm:space-y-12">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {steps.map((step, index) => (
            <div className="tt-luxury-card rounded-[8px] bg-paper/70 p-5 text-center shadow-[0_18px_45px_rgba(20,23,21,0.07)] sm:p-6" key={step}>
              <p className="mx-auto mb-4 flex size-9 items-center justify-center rounded-full bg-ink text-sm text-chalk sm:mb-5 sm:size-10">
